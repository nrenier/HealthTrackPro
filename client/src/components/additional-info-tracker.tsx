...
export default function AdditionalInfoTracker({
  ...
  const [visits, setVisits] = useState<
    Array<{ id: number; type: string; date: string; reportUrl?: string }>
  >([]);
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="grid grid-cols-3 gap-2">
              <Button
                variant={
                  physicalActivities.includes("none") ? "default" : "outline"
                }
              ...
              <Button
                variant={
                  physicalActivities.includes("yoga") ? "default" : "outline"
                }
              ...
              <Button
                variant={
                  physicalActivities.includes("running") ? "default" : "outline"
                }
              ...
              <Button
                variant={
                  physicalActivities.includes("cycling") ? "default" : "outline"
                }
              ...
              <Button
                variant={
                  physicalActivities.includes("walking") ? "default" : "outline"
                }
