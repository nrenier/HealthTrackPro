...
const measurementData = [
  { date: "Nov 23", weight: 65.2, bmi: 23.1, waterIntake: 2000 },
  { date: "Nov 24", weight: 65.3, bmi: 23.2, waterIntake: 2100 },
  { date: "Nov 25", weight: 65.1, bmi: 23.1, waterIntake: 1900 },
  { date: "Nov 26", weight: 65.4, bmi: 23.3, waterIntake: 2200 },
  { date: "Nov 27", weight: 65.2, bmi: 23.2, waterIntake: 2300 },
  { date: "Nov 28", weight: 65.5, bmi: 23.4, waterIntake: 2100 },
  { date: "Nov 29", weight: 65.3, bmi: 23.3, waterIntake: 2400 },
];
      ...
      <div className="flex-1 p-4 pb-20">
        <Tabs defaultValue="pain" className="space-y-4">
          ...
          <TabsContent value="measurements" className="space-y-4">
            <Card className="p-4">
              <h3 className="font-medium mb-4">Peso e BMI</h3>
              <ChartContainer config={chartConfig} className="h-[200px]">
                <Line
